...
const outputDirectory = mkdtempSync(join(tmpdir(), "mypick-assistant-tests-"));
...
try {
  const compile = spawnSync(
    ...
    [
      tscPath,
      "--project",
      resolve(repositoryRoot, "scripts/tsconfig.pick-assistant-tests.json"),
      "--outDir",
      outputDirectory,
    ],
  ...
  if (compile.status !== 0) {
    ...
    const testFile = resolve(outputDirectory, "scripts/pick-assistant.test.js");
