...
const outputDirectory = mkdtempSync(join(tmpdir(), "mypick-archetype-tests-"));
...
try {
  const compile = spawnSync(
    ...
    [
      tscPath,
      "--project",
      resolve(repositoryRoot, "scripts/tsconfig.archetype-affinity-tests.json"),
      "--outDir",
      outputDirectory,
    ],
  ...
  if (compile.status !== 0) {
    ...
    const testFile = resolve(
      outputDirectory,
      "scripts/archetype-affinity.test.js",
    );
